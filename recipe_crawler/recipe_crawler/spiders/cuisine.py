...
class cuisine_spider(scrapy.Spider):
	...
	def parse_recipe(self, response):
		for elements in response.css("div.recipe-body.summary"):
			...
			recipe_procedure = response.css("ol.recipe-procedures-list.instructions").xpath('//*[@id="recipe-wrapper"]/div/ol/li/div/p/text()').getall() 
